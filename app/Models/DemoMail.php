    ...
    public function getRows(): array
    {
        return [
            [
                ...
                'date' => $first_inbox_date = now()->setHour(9)->setMinute(0)->setSecond(0),
                'read' => true,
                'inbox_id' => 1,
                'labels' => json_encode([]),
            ],
            [
                ...
                'date' => $second_inbox_date = now()->setHour(9)->setMinute(0)->setSecond(0),
                'read' => true,
                'inbox_id' => 2,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                'id' => 3,
                'name' => 'Bob Johnson',
                ...
                'date' => $third_inbox_date = now()->setHour(9)->setMinute(0)->setSecond(0),
                'read' => true,
                'inbox_id' => 3,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $first_inbox_date->copy()->subDay(),
                'read' => false,
                'inbox_id' => 1,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $second_inbox_date->copy()->subDay(),
                'read' => false,
                'inbox_id' => 2,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $third_inbox_date->copy()->subDay(),
                'read' => true,
                'inbox_id' => 3,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $first_inbox_date->copy()->subDay(2),
                'read' => false,
                'inbox_id' => 1,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $second_inbox_date->copy()->subDay(2),
                'read' => true,
                'inbox_id' => 2,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $third_inbox_date->copy()->subDay(2),
                'read' => true,
                'inbox_id' => 3,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $first_inbox_date->copy()->subDay(3),
                'read' => false,
                'inbox_id' => 1,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $second_inbox_date->copy()->subDay(3),
                'read' => false,
                'inbox_id' => 2,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $third_inbox_date->copy()->subDay(3),
                'read' => true,
                'inbox_id' => 3,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $first_inbox_date->copy()->subDay(4),
                'read' => false,
                'inbox_id' => 1,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $second_inbox_date->copy()->subDay(4),
                'read' => true,
                'inbox_id' => 2,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $third_inbox_date->copy()->subDay(4),
                'read' => false,
                'inbox_id' => 3,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $first_inbox_date->copy()->subMonth(1),
                'read' => true,
                'inbox_id' => 1,
                'labels' => json_encode(['work', 'project']),
            ],
            [
                ...
                'date' => $second_inbox_date->copy()->subMonth(1),
                'read' => false,
                'inbox_id' => 2,
                'labels' => json_encode(['work', 'project']),
            ],
