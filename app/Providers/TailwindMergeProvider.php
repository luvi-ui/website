...
class TailwindMergeProvider extends ServiceProvider
{
public function register(): void
    ...
    {
        ComponentAttributeBag::macro('twMerge', function ($classList): ComponentAttributeBag {
            /** @var ComponentAttributeBag $this */
            $this->offsetSet('class', resolve(TailwindMergeContract::class)->merge(Arr::toCssClasses($classList), ($this->get('class', ''))));
